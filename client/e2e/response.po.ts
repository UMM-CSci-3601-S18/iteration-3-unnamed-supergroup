...
export class ResponsePo {
    ...
    clickGetResponseButton() {
        const responseButton = element(by.id('responseGetButton'));
    ...
    buttonExists(): promise.Promise<boolean> {
        this.highlightElement(by.id('submitEmoji'));
        return element(by.id('submitEmoji')).isPresent();
    }


    clickSlider(): promise.Promise<void> {
